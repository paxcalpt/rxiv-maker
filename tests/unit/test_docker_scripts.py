...
class TestDockerfileValidation:
    ...
    def test_dockerfile_syntax_directives(self):
        ...
        assert "syntax=docker/dockerfile:1" in content, "Should use modern Dockerfile syntax"
    ...
    def test_dockerfile_security_practices(self):
        ...
        assert "--no-cache" in content or "pip --no-cache-dir" in content, "Should avoid caching"
    ...
    def test_dockerfile_layer_optimization(self):
        ...
        if apt_install_lines:
            ...
            for line in apt_install_lines:
                ...
                cleanup_found = any(
                    'rm -rf /var/lib/apt/lists/*' in lines[i] or 'apt-get clean' in lines[i]
...
class TestBuildMultiArchScript:
    ...
    def test_build_script_help_function(self):
        ...
        assert "usage" in content.lower() or "help" in content.lower(), "Should show usage"
...
class TestQuickBuildScript:
    ...
    def test_quick_build_script_targets(self):
        ...
        assert "production" in content or "development" in content, "Should have build targets"
...
class TestDockerComposeConfiguration:
    ...
    def test_docker_compose_service_configuration(self):
        ...
        assert any(indicator in content.lower() for indicator in service_indicators), "Should have relevant service"
...
class TestDockerScriptIntegration:
    ...
    def test_script_error_codes(self):
        ...
        for script_path_str in scripts:
            ...
            assert has_exit or has_return, f"Script {script_path.name} should have error handling"
...
class TestDockerSecurityConfiguration:
    ...
    def test_dockerfile_port_exposure(self):
        ...
        for line in expose_lines:
            ...
            assert any(char.isdigit() for char in line), "Exposed ports should have numbers"
    ...
    def test_dockerfile_secrets_handling(self):
        ...
        for pattern in secret_patterns:
            assert pattern not in content.lower(), f"Dockerfile should not contain {pattern}"