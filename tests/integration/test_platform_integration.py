...
"""
        ...
        try:
            result = subprocess.run([
                ...
                "python", "--version"  # Simple test command
    ...
    def test_docker_platform_detection(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                assert arch in ["amd64", "arm64", "x86_64", "aarch64"], f"Unexpected architecture: {arch}"
            else:
    ...
    def test_docker_ignore_effectiveness(self):
        ...
        if dockerignore_path.exists():
            ...
            for pattern in important_patterns:
                assert pattern in content, f".dockerignore should include {pattern} pattern"
...
class TestCloudPlatformIntegration:
    ...
    def test_github_actions_workflow_syntax(self):
        ...
        if workflows_dir.exists():
            ...
            for workflow_file in workflow_files:
                ...
                assert "name:" in content, f"Workflow {workflow_file.name} should have name"
                assert "on:" in content, f"Workflow {workflow_file.name} should have triggers"
                assert "jobs:" in content, f"Workflow {workflow_file.name} should have jobs"
    ...
    def test_docker_compose_syntax_if_exists(self):
        ...
        for compose_file_path in compose_files:
            ...
            if compose_path.exists():
                ...
                assert "version:" in content, f"Compose file {compose_file_path} should have version"
                assert "services:" in content, f"Compose file {compose_file_path} should have services"
    ...
    def test_environment_variable_documentation(self):
        ...
        if readme_path.exists():
            ...
            assert documented_vars > 0, "README should document some environment variables"
...
class TestDocumentationIntegration:
    ...
    def test_platform_docs_cross_references(self):
        ...
        if docs_dir.exists():
            ...
            for doc_file in doc_files:
                ...
                assert "[" in content and "](" in content, f"{doc_file.name} should have markdown links"
    ...
    def test_readme_docker_hub_references(self):
        ...
        if readme_path.exists():
            ...
            assert "henriqueslab/rxiv-forge" in content, "README should reference Docker Hub repo"
    ...
    def test_documentation_consistency(self):
        ...
        for doc_file_path in doc_files:
            ...
            if doc_path.exists():
                ...
                assert image_name in content, f"{doc_file_path} should reference correct image name"