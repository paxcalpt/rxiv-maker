...
class FigureGenerator:
    ...
    def __init__(self, figures_dir="FIGURES", output_dir="FIGURES", output_format="png"):
    ...
    def generate_python_figure(self, py_file):
        ...
        try:
            ...
            ], capture_output=True, text=True, cwd=str(self.output_dir.absolute()))
            ...
            for file_path in current_files:
                ...
                if (base_name.lower() in file_path.stem.lower() or 
                    file_path.stem.lower().startswith('figure') or
                    file_path.stem.lower().startswith('fig')):
