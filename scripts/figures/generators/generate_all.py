...
def generate_all_figures(figure_types: Optional[List[str]] = None) -> bool:
    """
    ...
    figure_scripts = {
        ...
        'enhanced-mermaid': script_dir / 'generate_enhanced_mermaid.py',
    }
...
def main():
    ...
    parser.add_argument('--types', nargs='+', 
                       choices=['matplotlib', 'seaborn', 'mermaid', 'enhanced-mermaid'],
