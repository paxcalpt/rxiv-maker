...
from figures.matplotlib_config import (
...
if __name__ == '__main__':
    ...
    # Generate figures
    print("Generating Figure 1: Preprint Growth Analysis...")
    generate_figure1(output_dir)
    
    print("Generating subplot example...")
...
def generate_subplot_example(output_dir: Path) -> None:
    ...
    # Plot 4: Histogram
    data = np.random.normal(0, 1, 1000)
    ax4.hist(data, bins=30, color=COLORS['muted'], alpha=0.7, edgecolor='black')
